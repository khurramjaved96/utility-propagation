...
#ifndef INCLUDE_NN_NETWORKS_RECURRENT_CLASSIFIER_H_
#define INCLUDE_NN_NETWORKS_RECURRENT_CLASSIFIER_H_
...
class RecurrentClassifierNetwork : public NeuralNetwork {
 ...
 public:
  ...
  RecurrentClassifierNetwork(float step_size, int seed, int no_of_input_features, int total_targets, int total_recurrent_features, int connections_per_feature);

  ~RecurrentClassifierNetwork();
...
#endif //INCLUDE_NN_NETWORKS_RECURRENT_CLASSIFIER_H_
